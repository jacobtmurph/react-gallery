...
class App extends Component {
 ...
 componentDidMount() {
      fetch(`https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=${flickrKey}&tags=Belfast&per_page=25&format=json&nojsoncallback=1`)
      .then( response => response.json())
      .then( responseData => this.setState({flickr: responseData.photos.photo }) )
      .catch(error => {
